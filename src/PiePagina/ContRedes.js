...
export default function ContRedes(){
    return(
        <div className='redescont'>
            <a href='https://www.facebook.com/nico.comba.50/' target={"_blank"} rel="noreferrer" className='redesitems'><img className='redesitems__img' src="./RedesIMG/facebook.svg" alt="encuentra tu pagina web en nuestra red social, facebook" /></a>
